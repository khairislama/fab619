...
export default function ServiceCard({
  ...
  return (
    <div className="relative h-[270px] 2k:h-[300px] group overflow-hidden">
      <Image
        src={backgroundImage}
        alt={title}
        fill
      ...
      <div className="absolute inset-0 p-6 lg:p-10 flex flex-col justify-between">
        ...
        <h3 className="text-lg 2k:text-xl font-bold text-white">{title}</h3>
        <p className="text-xs 2k:text-sm text-white/90">{description}</p>
        <Button
          variant="outline"
